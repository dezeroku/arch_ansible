...
def set_gpu_fan(speed):
    ...
    command = "sudo /home/d0ku/bin/acer_ec.pl writetemp 152 "+str(speed)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--gpu", help="Custom automatic control over GPU fan.",
                        action="store_true")
    parser.add_argument("--cpu", help="Custom automatic control over CPU fan.",
                        action="store_true")
    parser.add_argument("--both", help="Custom automatic control over CPU and\
                        GPU fan.",
                        action="store_true")
